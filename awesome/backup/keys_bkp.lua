...
-- TODO Need to fix the useless spaces
...
-- {{{ Key bindings
keys.globalkeys = gears.table.join( -- {{{ View
-- Screen relatedawful.key({modkey, "Control"}, "j",
...
awful.key({modkey}, ",", awful.tag.viewprev,
    ...
    awful.layout.inc(-1)
end, {description = "select previous", group = "layout"}), -- Client related
...
-- {{{ Programs
    ...
    awful.key({modkey}, "Return", function() awful.spawn("dmenu_run") end, 
...
end, {description = "lua execute prompt", group = "awesome"}), -- }}} /Programs
-- {{{ Misc
...
keys.clientkeys = gears.table.join(awful.key({modkey}, "q",
